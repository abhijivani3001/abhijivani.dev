            ...
            <div className="flex flex-col items-start gap-4">
              <div className="overflow-hidden">
                <div className="dark:text-white text-animation">
                  Hi everyone, I&apos;m a MERN stack developer with over 3 years
                  of experience building full-stack web applications. I&apos;m
                  passionate about creating user-friendly and scalable
              ...
              <div className="flex gap-1 flex-col items-start">
                <Link
                  ...
                  aria-label="Vishwakarma Government Engineering College"
                  rel="noopener noreferrer"
                >
                  <div className="text-accentColor navlink text-md font-semibold">
                    Vishwakarma Government Engineering College (2021 - 25)
                  </div>
                  <ArrowRight
                    className="text-accentColor -rotate-45"
                    size={15}
                  />
                </Link>
                ...
                <div className="overflow-hidden">
                  <div className="dark:text-white text-animation">
                    Currently pursuing a Bachelor of Engineering degree in
                    Information Technology at Vishwakarma Government Engineering
                    College (batch of 2021-2025).
                  </div>
                </div>
              </div>
            </div>
