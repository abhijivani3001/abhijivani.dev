      ...
      <div className="w-full max-w-[1100px] h-full m-auto flex flex-col gap-40 items-center">
        ...
        <div className="flex flex-col gap-8 items-center">
          <div className="flex items-center gap-4">
            <Link
              href="https://www.linkedin.com/in/abhijivani/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Contact me on linkedin"
              className="rounded-full flex items-center gap-2 border py-[1px] px-4 transition hover:scale-110 duration-300"
            >
            ...
            <Link
              href="https://twitter.com/abhijivani3001"
              aria-label="Contact me on Twitter"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full flex items-center gap-2 border py-[5px] px-4 transition hover:scale-110 duration-300"
            >
              <svg
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="dark:text-white text-sm">Tech Enthusiast</div>
          </div>
