  ...
  return (
    ...
    >
      <div className="overflow-hidden">
        <div className="text-animation py-2 dark:bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-black dark:text-transparent bg-clip-text leading-none text-4xl md:text-6xl font-semibold">
          It&apos;s Abhi Jivani
        </div>
      </div>
      ...
      <div className="overflow-hidden">
        <div className="text-animation text-2xl md:text-4xl font-semibold">
          ...
          <span className="text-accentColor">MERN Stack</span>{" "}
      ...
      <div className="w-[300px] md:w-[370px] relative z-30 text-center text-sm dark:bg-[linear-gradient(#fff,rgba(255,255,255,.6))] inline-block text-black dark:text-transparent bg-clip-text">
        Passionate and detail-oriented MERN stack developer with a knack for
        creating visually appealing and user-friendly scalable web applications
      </div>
